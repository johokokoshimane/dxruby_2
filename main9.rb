require 'dxruby'
require_relative 'hasami'
require_relative 'color'
require_relative 'slide'
require_relative 'main10'

class Main9
	def initialize()
										Input.setRepeat( 0, 0 )
						key_codes = {K_A => "SCISSORS",
			K_B => "B",
			K_C => "C",
			K_D => "D",
			K_E => "E",
...
str = ""
		...
		sakamo = Image.new(200, 100, [255, 255, 255])
		button_image9 = Image.new(150, 150, [20, 255, 255])
		button9 = Sprite.new(300, 50, sakamo)
		button9.image.drawFontEx(50,32,"はさみ", font,{color:[255,255,0,0]})
