require 'dxruby'
require_relative 'hana'
require_relative 'color'
require_relative 'slide'
require_relative 'main7'

class Main6
	def initialize()
						Input.setRepeat( 0, 0 )
						key_codes = {K_A => "FLOWER",
			K_B => "B",
			K_C => "C",
			K_D => "D",
			K_E => "E",
...
str = ""
		...
		koto = Image.new(200, 100, [255, 255, 255])
		button_image6 = Image.new(150, 150, [20, 255, 255])
		button6 = Sprite.new(300, 50, koto)
		button6.image.drawFontEx(50,32,"はな", font,{color:[255,255,0,0]})
