...
str = ""
		...
		kadowaki = Image.new(200, 100, [255, 255, 255])
		button_image14 = Image.new(150, 150, [20, 255, 255])
		button14 = Sprite.new(300, 50, kadowaki)
		button14.image.drawFontEx(0,0,"木", font,{color:[255,255,0,0]})
