...
A = Image.new(200, 100, [255, 255, 255])
B = Image.new(200, 100, [255, 255, 255])
button_image1 = Image.new(100, 100, [255, 255, 255])
button_image2 = Image.new(100, 100, [255, 255, 255])
button_image3 = Image.new(150, 150, [255, 255, 255])
button1 = Sprite.new(300, 50, A)
button1.image.drawFontEx(0,0,"りんご", font,{color:[255,255,0,0]})
button01 = Sprite.new(150, 400, B)
...
Window.loop do 
	...
	# 1ページ目のボタン
#	if !cursor.check(button11).empty? && Input.mouse_push?(M_LBUTTON)
		# 次の画面の作成
		# 次へボタンを追加↓
#		next_page = Main2.new
		#str = ""
