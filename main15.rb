...
str = ""
		...
		batta = Image.new(200, 100, [255, 255, 255])
		button_image16 = Image.new(150, 150, [20, 255, 255])
		button16 = Sprite.new(300, 50, batta)
		button16.image.drawFontEx(0,0,"目", font,{color:[255,255,0,0]})
