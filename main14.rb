require 'dxruby'
require_relative 'kutusita'
require_relative 'color'
require_relative 'slide'
require_relative 'main15'
...
str = ""
		...
		kamakiri = Image.new(200, 100, [255, 255, 255])
		button_image15 = Image.new(150, 150, [20, 255, 255])
		button15 = Sprite.new(300, 50, kamakiri)
		button15.image.drawFontEx(0,0,"くつした", font,{color:[255,255,0,0]})
		...
		kutusita = Kutusita.new(0,0)

		# 1ページ目の準備 
		slide = Slide.new
		slide.parts << kutusita
		
		slide.parts << button15
		next_page = [slide]
enter = 0
result = false
		Window.loop do
