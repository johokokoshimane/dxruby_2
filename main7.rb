require 'dxruby'
require_relative 'ame'
require_relative 'color'
require_relative 'slide'
require_relative 'main8'
...
str = ""
		...
		eigo = Image.new(200, 100, [255, 255, 255])
		button_image7 = Image.new(150, 150, [20, 255, 255])
		button7 = Sprite.new(300, 50, eigo)
		button7.image.drawFontEx(50,32,"キャンディー", font,{color:[255,255,0,0]})
