require 'dxruby'
require_relative 'pasokon'
require_relative 'color'
require_relative 'slide'
require_relative 'main19'

class Main18
	def initialize()
				Input.setRepeat( 0, 0 )
						key_codes = {K_A => "COMPUTER",
			K_B => "B",
			K_C => "C",
			K_D => "D",
			K_E => "E",
...
str = ""
		...
		kami = Image.new(200, 100, [255, 255, 255])
		button_image19 = Image.new(150, 150, [20, 255, 255])
		button19 = Sprite.new(300, 50, kami)
		button19.image.drawFontEx(0,0,"パソコン", font,{color:[255,255,0,0]})
		...
		pasokon = Pasokon.new(0,0)

		# 1ページ目の準備 
		slide = Slide.new
		slide.parts << pasokon
		slide.parts << button19
		next_page = [slide]
enter = 0
result = false
		Window.loop do
