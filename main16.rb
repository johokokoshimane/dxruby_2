...
str = ""
		...
		musi = Image.new(200, 100, [255, 255, 255])
		button_image17 = Image.new(150, 150, [20, 255, 255])
		button17 = Sprite.new(300, 50, musi)
		button17.image.drawFontEx(0,0,"牛乳", font,{color:[255,255,0,0]})
