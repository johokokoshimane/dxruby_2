...
str = ""
		...
		ie = Image.new(200, 100, [255, 255, 255])
		button_image29 = Image.new(150, 150, [20, 255, 255])
		button29 = Sprite.new(300, 50, ie)
		button29.image.drawFontEx(0,0,"帽子", font,{color:[255,255,0,0]})
		...
		boushi = Boushi.new(0,0)

		# 1ページ目の準備 
		slide = Slide.new
		slide.parts << boushi
		slide.parts << button29
		next_page = [slide]
enter = 0
result = false
		Window.loop do
