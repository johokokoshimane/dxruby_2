...
str = ""
		...
		oda = Image.new(200, 100, [255, 255, 255])
		button_image24 = Image.new(150, 150, [20, 255, 255])
		button24 = Sprite.new(300, 50, oda)
		button24.image.drawFontEx(0,0,"太陽", font,{color:[255,255,0,0]})
