...
str = ""
		...
		taka = Image.new(200, 100, [255, 255, 255])
		button_image11 = Image.new(150, 150, [20, 255, 255])
		button11 = Sprite.new(300, 50, taka)
		button11.image.drawFontEx(50,32,"たまご", font,{color:[255,255,0,0]})
