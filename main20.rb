require 'dxruby'
require_relative 'saru'
require_relative 'color'
require_relative 'slide'
require_relative 'main21'

class Main20
	def initialize()
				Input.setRepeat( 0, 0 )
						key_codes = {K_A => "MONKEY",
			K_B => "B",
			K_C => "C",
			K_D => "D",
			K_E => "E",
...
str = ""
		...
		tomi = Image.new(200, 100, [255, 255, 255])
		button_image22 = Image.new(150, 150, [20, 255, 255])
		button22 = Sprite.new(300, 50, tomi)
		button22.image.drawFontEx(0,0,"さる", font,{color:[255,255,0,0]})
