...
str = ""
		...
		hide = Image.new(200, 100, [255, 255, 255])
		button_image23 = Image.new(150, 150, [20, 255, 255])
		button23 = Sprite.new(300, 50, hide)
		button23.image.drawFontEx(0,0,"笑顔", font,{color:[255,255,0,0]})
